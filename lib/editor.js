  ...
  _createClass(Editor, [
    {
      ...
      value: function init(props) {
        ...
        var graph = new mxGraph(containerEle, model); // eslint-disable-line
    ...
    {
      key: "createCell",
      value: function createCell(label, x, y, width, height, shapeStyle) {
        return new mxCell(
          label,
    ...
    {
      key: "addCells",
      value: function createCell(cells) {
    ...
    },
    {
      ...
      value: function groupCells(groupId, labelName) {
        ...
        cellsGrouped &&
          cellsGrouped.forEach(function (item) {
            item.isGrouped = true;
          });
    ...
    },
    {
      ...
      value: function clearGraph() {
        return _util2.default.clearGraph({
          graph: this.graph,
        });
      },
    ...
    },
    {
      ...
      value: function insertEdge(
        ...
        return this.graph.insertEdge(parent, id, label, v1, v2, edgeStyle);
      },
